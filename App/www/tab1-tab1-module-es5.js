...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tab1-tab1-module"], {
  ...
  function srcAppTab1Tab1PageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var Tab1Page = /*#__PURE__*/function () {
      function Tab1Page(sanitizer, httpClient) {
        _classCallCheck(this, Tab1Page);

        this.sanitizer = sanitizer;
        this.httpClient = httpClient;
        this.baseUrl = 'http://vps183484.vps.ovh.ca:3000';
      ...
      _createClass(Tab1Page, [{
        key: "uploadImages",
        value: function uploadImages(contents) {
          console.log('uploadImages/contents: ' + contents);
          var formData = new FormData();
          formData.append('photos', contents, 'filename');
          this.httpClient.post("".concat(this.baseUrl, "/image-upload"), formData); //	return this.httpClient.post<any[]>(`${this.baseUrl}/upload-photos`, formData).toPromise();
        }
      }, {
        key: "sendImage",
        value: function sendImage(image) {
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    fetch(image.webPath).then(function (res) {
                      return console.log('sendImage/res:' + res);
                    });
                    fetch(image.webPath).then(function (res) {
                      return console.log('sendImage/res.blob:' + res.blob());
                    });
                    fetch(image.webPath).then(function (res) {
                      return _this15.uploadImages(res.blob());
                    });
        ...
        key: "sendImage2",
        value: function sendImage2(image) {
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    console.log(image.path);
                    _context2.next = 4;
                    return Filesystem.readFile(image.webPath);

                  case 4:
                    contents = _context2.sent;
                    console.log('contents');
                    console.log(contents);
                    return _context2.abrupt("return", this.httpClient.post("".concat(this.baseUrl, "/upload-photos"), contents).toPromise());
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_3__["DomSanitizer"], _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"]])], Tab1Page);
    /***/
  }
}]);

  ...
  function node_modulesIonicPwaElementsDistEsmShadowCssD7d058ecD59cb009Js(module, __webpack_exports__, __webpack_require__) {
    ...
    var applyStrictSelectorScope = function applyStrictSelectorScope(selector, scopeSelector, hostSelector) {
      ...
      while ((res = sep.exec(selector)) !== null) {
        ...
        var _part2 = selector.slice(startIndex, res.index).trim();

        shouldScope = shouldScope || _part2.indexOf(_polyfillHostNoCombinator) > -1;
        var scopedPart = shouldScope ? _scopeSelectorPart(_part2) : _part2;
        scopedSelector += "".concat(scopedPart, " ").concat(separator, " ");
        startIndex = sep.lastIndex;
      }
    ...
    var scopeCss = function scopeCss(cssText, scopeId, commentOriginalSelector) {
      ...
      if (commentOriginalSelector) {
        orgSelectors.forEach(function (_ref2) {
